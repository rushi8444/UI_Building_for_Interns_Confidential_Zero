...
# Extract L1 structs and DataPipeWorkerThread from l1_code
m = re.search(r'(#pragma pack\(push, 1\).*?DWORD WINAPI DataPipeWorkerThread.*?return 0;\n})', l1_code, re.DOTALL)
l1_structs = m.group(1) if m else ""

m2 = re.search(r'(static bool SafeGetMarketSorterData.*?return false;\n    }\n})', l1_code, re.DOTALL)
l1_helpers = m2.group(1) if m2 else ""

m3 = re.search(r'(class OneMinuteCsvLoggerRowValue : public CharPtrRowValue.*?};\n)', l1_code, re.DOTALL)
l1_class = m3.group(1) if m3 else ""
...
m4 = re.search(r'(bool WINAPI IsTraderIdValid.*?#endif)', l1_code, re.DOTALL)
l1_exports = m4.group(1) if m4 else ""
